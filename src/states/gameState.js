...
class Game {
    ...
    preload () {
        ...
        game.load.tilemap('ludmap', IMGPATH+'ludMap37.json', null, Phaser.Tilemap.TILED_JSON);
        game.load.image('tiles', IMGPATH+'mapTile.png');
        game.load.image('carT', IMGPATH+'carTile.png');
        game.load.image('bullet', IMGPATH+'toilet32.png');
    }
    ...
    create () {
        ...
        this.map.addTilesetImage('carTile', 'carT');
